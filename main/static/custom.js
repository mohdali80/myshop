$(document).ready(function(){
    ...
    $(".choose-color").on('click',function(){
        ...
        $(".choose-color").removeClass('focused'); //focused from custom.css
        ...
        $.ajax({
            ...
            success:function(res){
                if(res.bool==true){
                    ...
                    $("#reser").trigger('click');
                    // Hide Button after ading one comment
                    $(".reviewBtn").hide();
                    // End
                    ...
                    // When add the first review hide the pargraph which saying "Add First Review" in product_details.html
                    $(".no-data").hide();
                    ...
                    // Avg Rating
                    $(".avg-rating").text(res.avg_reviews.avg_rating.toFixed(1)) // we add .text because it is <span>
                }
            }
        });
        e.preventDefault();
